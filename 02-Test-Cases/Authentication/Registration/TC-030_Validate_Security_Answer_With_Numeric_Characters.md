# TC-030 - Validate Security Answer With Numeric Characters
...
The system should accept numeric characters in the "Security Answer" field and allow the registration process to continue
